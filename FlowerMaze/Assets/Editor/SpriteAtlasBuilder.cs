...
namespace AsepriteImporter
{
    public class SpriteAtlasBuilder
    {
        ...
        public Texture2D GenerateAtlas(Texture2D[] sprites, out UnityEditor.AssetImporters.SpriteImportData[] spriteData, bool mask, bool baseTwo = true)
        {
        ...
        public Texture2D GenerateAtlas(Texture2D[] sprites, out UnityEditor.AssetImporters.SpriteImportData[] spriteData, int cols, int rows, bool baseTwo = true)
        {
        ...
        public Texture2D GenerateAtlas(Texture2D[] sprites, out UnityEditor.AssetImporters.SpriteImportData[] spriteData, int cols, int rows, Color mask, bool baseTwo = true)
        {
            var spriteImportData = new List<UnityEditor.AssetImporters.SpriteImportData>();
